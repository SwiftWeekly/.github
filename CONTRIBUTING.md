...
Please review and abide by [our code of conduct](https://github.com/SwiftWeekly/.github/blob/master/CODE_OF_CONDUCT.md).
...
* All content must align with [Our Standards](https://github.com/SwiftWeekly/.github/blob/master/CODE_OF_CONDUCT.md#our-standards), outlined in the Code of Conduct. Language must be welcoming, inclusive, respectful, etc.
